...
//студента съвпада с тази на групата, и разбира се, ако има свободни места. След добавяне на студент към групата да се намалят свободните места в групата.
            ...
            if (student.getSubject().equals(this.groupSubject)) {
                for (int i = 0; i < this.students.length; i++) {
                    if (this.students[i] == null) {
                        ...
                        this.freePlaces--;
                        System.out.println(student.getName() + " added to the group");
                        return;
                ...
                System.out.println("Student " + student.getName() + " does not match the group subject");
            }
    ...
    String theBestStudent() {
        ...
        if (bestStudent != null) {
            System.out.println("The best student in this group " + this.groupSubject + " is " + bestStudent.getName());
        ...
        for (int i = 0; i < this.students.length; i++) {
            ...
            if (student != null) { // Check if the current student is not null
                System.out.println("Name: " + student.getName() + ", Grade: " + student.getGrade() +
                        ", Year: " + student.getYearInCollege() + ", Age: " + student.getAge() +
